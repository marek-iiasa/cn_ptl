...
*        Solve MESSAGE_LP using LP minimizing CO2_CUM ;
    Solve MESSAGE_LP using LP minimizing COST_CUM ;
    put_utility 'log' /'+++ After Solve Message_LP +++ ' ;
...
* write a status update and time elapsed to the log file, solve the model
        ...
        Solve MESSAGE_LP using LP minimizing OBJ ;
******           does not come here for the cn-ptl model
*           Solve MESSAGE_LP using LP minimizing CO2_CUM ;
