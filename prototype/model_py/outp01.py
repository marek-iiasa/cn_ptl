...
The *gdx files and the act.csv file are located in the directory named after the corresponding MCMA
...
mk_csv = False      # if True only ACT csv if written
...
for itr_id in itr_lst:
    ...
    # extract subset of ACT (compound variable representing activities) values
