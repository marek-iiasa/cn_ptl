...
The *gdx files and the act.csv file are located in the directory 945 (the number indicates the MCMA analysis id
to which all iterations belong).
"""
import gdxpds
...
for itr_id in itr_lst:
    ...
    # select values of ACT for the subset of technologies defined by tec
    df_cols = ['tec', 'vintage', 'year_all', 'Level']
    tec = ['OTL', 'CTL', 'PTL', 'BTL']
